...
u8 MBC0::read_rom(u16 at) const { return rom_bank[at]; }

u8 MBC0::read_ram(u16 at) const { return ram_bank[at - EXRAM_S]; }

void MBC0::write_rom(u16, u8) { return; }

void MBC0::write_ram(u16 at, u8 data) { ram_bank[at - EXRAM_S] = data; }
