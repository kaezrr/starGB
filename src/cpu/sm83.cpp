...
u8 CPU::read_r16mem(u8 r) {
    switch (r) {
    case 0:
        return read_mem(BC.full);
    case 1:
        return read_mem(DE.full);
    case 2:
        return read_mem(HL.full++);
    case 3:
        return read_mem(HL.full--);
...
void CPU::write_r16mem(u8 r, u8 data) {
    switch (r) {
    case 0:
        write_mem(BC.full, data);
        break;
    case 1:
        write_mem(DE.full, data);
        break;
    case 2:
        write_mem(HL.full++, data);
        break;
...
u8 CPU::get_nextu8() { return read_mem(PC.full++); }
...
bool CPU::get_flag(Flag flag) const { return AF.lo & flag; }
